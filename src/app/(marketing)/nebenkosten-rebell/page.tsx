    ...
    <div className="min-h-screen bg-[#0F172A] text-white">
      ...
      <main className="max-w-4xl mx-auto px-6 pt-20 pb-32 text-center">
        ...
        <p className="text-xl text-[#94A3B8] mb-12 max-w-2xl mx-auto">
          Prüfe deine Nebenkostenabrechnung. Abrechnung nachvollziehen. Auffälligkeiten und offene Punkte strukturieren.
        </p>
        ...
        <div className="grid md:grid-cols-3 gap-8 text-left max-w-3xl mx-auto">
          <div>
            <h3 className="font-bold text-lg mb-2 text-[#E2E8F0]">1. Abrechnung erfassen</h3>
            <p className="text-[#64748B] text-sm">Wichtige Angaben aus deiner Abrechnung übernehmen.</p>
          </div>
          <div>
            <h3 className="font-bold text-lg mb-2 text-[#E2E8F0]">2. Kosten nachvollziehen</h3>
            <p className="text-[#64748B] text-sm">Positionen, Vorauszahlungen und Veränderungen strukturiert betrachten.</p>
          </div>
          <div>
            <h3 className="font-bold text-lg mb-2 text-[#E2E8F0]">3. Weiteres Vorgehen vorbereiten</h3>
            <p className="text-[#64748B] text-sm">Offene Punkte dokumentieren und passende Schreiben vorbereiten.</p>
          </div>
        </div>
      </main>
    </div>

  ...
  return (
    <div className="min-h-screen bg-[#0F172A] text-white">
      ...
      <header className="flex justify-between items-center p-6 lg:px-12 max-w-7xl mx-auto">
        ...
        <button
          onClick={() => router.push("/app/nebenkosten-rebell")}
      ...
      <main className="max-w-4xl mx-auto px-6 pt-20 pb-32 text-center">
        ...
        <h1 className="text-4xl md:text-6xl font-extrabold mb-6 leading-tight text-[#F8FAFC]">
          Zahlst du zu viel für <br className="hidden md:block" />deine Nebenkosten?
        </h1>
        <p className="text-xl text-[#94A3B8] mb-12 max-w-2xl mx-auto">
          Prüfe deine Nebenkostenabrechnung auf Fehler. Viele Abrechnungen sind fehlerhaft – hol dir dein Geld vom Vermieter zurück.
        </p>

        <div className="bg-[#1E293B] border border-[#334155] rounded-xl p-8 max-w-lg mx-auto mb-12 shadow-2xl">
          <h2 className="text-2xl font-bold mb-4 text-[#F8FAFC]">Abrechnung prüfen</h2>
          <p className="text-[#94A3B8] mb-6 text-sm">
            Einfach Daten eingeben und sofort erfahren, ob deine Nebenkostenabrechnung auffällige Abweichungen enthält.
          </p>
          <button 
            onClick={() => router.push("/app/nebenkosten-rebell")}
        ...
        <div className="grid md:grid-cols-3 gap-8 text-left max-w-3xl mx-auto">
          <div>
            <h3 className="font-bold text-lg mb-2 text-[#E2E8F0]">1. Daten eintragen</h3>
            <p className="text-[#64748B] text-sm">Werte aus deiner Abrechnung übernehmen.</p>
          </div>
          <div>
            <h3 className="font-bold text-lg mb-2 text-[#E2E8F0]">2. Analyse starten</h3>
            <p className="text-[#64748B] text-sm">Vergleich mit aktuellen Referenzwerten.</p>
          </div>
          <div>
            <h3 className="font-bold text-lg mb-2 text-[#E2E8F0]">3. Widerspruch einlegen</h3>
            <p className="text-[#64748B] text-sm">Generiere ein rechtssicheres Dokument.</p>
          </div>
        </div>
      </main>
    </div>

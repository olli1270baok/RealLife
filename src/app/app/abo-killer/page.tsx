      ...
      <div className="min-h-screen bg-[#F5F4F0] flex items-center justify-center p-6 text-center">
        <div className="bg-white p-8 rounded-xl shadow-lg max-w-md w-full">
          ...
          <div className="flex flex-col gap-4">
            <button onClick={() => router.push('/abo-killer')} className="bg-gray-100 text-[#1e3a8a] py-3 rounded-lg font-bold hover:bg-gray-200 transition-colors w-full">
              App ansehen
            </button>
            <button onClick={() => {
              import('@/lib/commerce/checkout').then(m => m.startCheckout('aboKiller'));
        ...
        {!loadingUser && !isPro && (
          <div style={{ position: 'absolute', top: 0, left: 0, right: 0, bottom: 0, background: 'rgba(3, 7, 18, 0.8)', backdropFilter: 'blur(20px)', zIndex: 50, display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
            <div style={{ background: 'var(--card)', border: '1px solid var(--border)', borderRadius: '24px', padding: '60px 40px', maxWidth: '600px', textAlign: 'center', boxShadow: '0 20px 60px rgba(0,0,0,0.5)', backdropFilter: 'blur(16px)' }}>
              ...
              <button className="btn btn-primary" style={{ width: '100%', padding: '20px', fontSize: '18px' }} onClick={() => import('@/lib/commerce/checkout').then(m => m.startCheckout('aboKiller'))}>

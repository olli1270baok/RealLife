...
const ARSENAL = {
  ...
  ordnungsamt: [
    { cat:'cat_ord', icon:'🚗', key:'stvo12', title:{de:'§ 12 StVO — Halten und Parken',en:'§ 12 StVO — Parking'}, preview:{de:'Verbotene Park- und Haltezonen',en:'Prohibited parking'}, text:'Das Halten und Parken ist u.a. unzulässig auf Gehwegen, in Feuerwehrzufahrten, auf Radwegen, vor Ausfahrten und an engen Stellen. Verstöße sind Ordnungswidrigkeiten.' },
    { cat:'cat_ord', icon:'🚗', key:'stvo41', title:{de:'§ 41 StVO — Verbotsschilder',en:'§ 41 StVO — Prohibition signs'}, preview:{de:'Halte- und Parkverbote',en:'Parking prohibition signs'}, text:'Haltverbotsschilder (Zeichen 283) und Parkverbotsschilder (Zeichen 286) sind absolut verbindlich. Zuwiderhandlungen sind bußgeldbewehrt.' },
    { cat:'cat_ord', icon:'🚲', key:'stvo2', title:{de:'§ 2 StVO — Fahrbahnen / Radwegpflicht',en:'§ 2 StVO — Lanes'}, preview:{de:'Benutzungspflicht Radweg',en:'Cycle path obligation'}, text:'Radfahrer sind auf freigegebenen oder benutzungspflichtigen Radwegen zu fahren. Das Zuparken eines Radweges ist verboten und gefährlich.' },
    { cat:'cat_ord', icon:'🛣️', key:'strasseng', title:{de:'Straßenverkehrsgesetz (StVG)',en:'Road Traffic Act'}, preview:{de:'Haftung bei Schäden durch Parkverstöße',en:'Liability'}, text:'Bei Schäden durch Falschparker haftet der Fahrzeughalter gemäß § 7 StVG. Das Ordnungsamt kann Abschleppkosten auf den Halter übertragen.' },
    { cat:'cat_ord', icon:'🗑️', key:'krwg28', title:{de:'§ 28 KrWG — Illegale Müllentsorgung',en:'§ 28 KrWG'}, preview:{de:'Pflicht zur ordnungsgemäßen Entsorgung',en:'Waste disposal duty'}, text:'Abfälle dürfen nur in zugelassenen Anlagen entsorgt werden. Illegales Entsorgen im öffentlichen Raum ist eine Ordnungswidrigkeit (Bußgeld bis zu 100.000 €).' },
    { cat:'cat_ord', icon:'🔊', key:'owig117', title:{de:'§ 117 OWiG — Unzulässiger Lärm',en:'§ 117 OWiG — Noise'}, preview:{de:'Lärmbelästigung',en:'Noise pollution'}, text:'Ordnungswidrig handelt, wer ohne berechtigten Anlass Lärm erregt, der geeignet ist, die Allgemeinheit erheblich zu belästigen. Bußgeld bis zu 5.000 €.' },
    { cat:'cat_ord', icon:'🌿', key:'stvo32', title:{de:'§ 32 StVO — Hindernisse',en:'§ 32 StVO — Obstacles'}, preview:{de:'Überhängende Äste, Hecken',en:'Overhanging branches'}, text:'Es ist verboten, die Straße zu beschmutzen oder zu beschädigen oder auf ihr Hindernisse zu bereiten. Überhängender Bewuchs auf öffentlichen Wegen ist zu beseitigen.' },
    { cat:'cat_ord', icon:'🏛️', key:'gemeindeordnung', title:{de:'Gemeindeordnung — Verkehrssicherungspflicht',en:'Municipal Code'}, preview:{de:'Pflicht der Gemeinde zum Straßenunterhalt',en:'Road maintenance duty'}, text:'Gemeinden haben eine Verkehrssicherungspflicht für öffentliche Straßen und Wege. Schäden (z.B. Schlaglöcher) müssen unverzüglich behoben werden.' },
    { cat:'cat_ord', icon:'⚙️', key:'stvo46', title:{de:'§ 46 StVO — Ausnahmegenehmigungen',en:'§ 46 StVO — Exemptions'}, preview:{de:'Ausnahmen vom Parkverbot',en:'Parking exemptions'}, text:'Die zuständige Behörde kann Ausnahmen von den Verboten der StVO genehmigen. Ohne solche Genehmigung gelten alle Verbote uneingeschränkt.' },
    { cat:'cat_ord', icon:'💡', key:'strassenbeleuchtung', title:{de:'StrWG — Straßenbeleuchtungspflicht',en:'StrWG — Street lighting'}, preview:{de:'Pflicht zur Straßenbeleuchtung',en:'Street lighting duty'}, text:'Gemeinden sind nach dem jeweiligen Landesstraßengesetz verpflichtet, öffentliche Straßen und Wege verkehrssicher zu beleuchten. Ausfall ist unverzüglich zu beheben.' },
    { cat:'cat_ord', icon:'🐕', key:'hundesteuer', title:{de:'Gemeindesatzung — Hundehaltung',en:'Municipal dog rules'}, preview:{de:'Anleinpflicht, Reinigungspflicht',en:'Leash and cleanup duty'}, text:'Hundehalter sind verpflichtet, öffentliche Wege von Hundekot zu reinigen. Verstöße können durch Gemeindebußgelder geahndet werden.' },
    { cat:'cat_ord', icon:'🚙', key:'stvo12abs3', title:{de:'§ 12 Abs. 3b StVO — Schrottfahrzeuge',en:'§ 12 StVO — Abandoned vehicles'}, preview:{de:'Abgestellt ohne Kennzeichen',en:'Abandoned without plates'}, text:'Fahrzeuge ohne Zulassung (ohne Kennzeichen) dürfen nicht auf öffentlichem Verkehrsraum abgestellt werden. Die Behörde kann Abschleppung anordnen.' },
    { cat:'cat_ord', icon:'🏘️', key:'immissionsschutz', title:{de:'BImSchG — Immissionsschutz',en:'BImSchG'}, preview:{de:'Schutz vor Lärm und Geruch',en:'Emission protection'}, text:'Das Bundes-Immissionsschutzgesetz schützt Menschen vor schädlichen Umwelteinwirkungen (Lärm, Geruch, Staub). Behörden können Anlagen und Tätigkeiten einschränken.' },
    { cat:'cat_ord', icon:'⚖️', key:'owig1', title:{de:'§ 1 OWiG — Ordnungswidrigkeit',en:'§ 1 OWiG'}, preview:{de:'Definition Ordnungswidrigkeit',en:'Definition'}, text:'Eine Ordnungswidrigkeit ist eine rechtswidrige und vorwerfbare Handlung, die den Tatbestand eines Gesetzes verwirklicht, das die Ahndung mit einer Geldbuße zulässt.' },
    { cat:'cat_ord', icon:'📋', key:'owig35', title:{de:'§ 35 OWiG — Anzeigepflicht',en:'§ 35 OWiG'}, preview:{de:'Recht zur Erstattung einer Anzeige',en:'Right to file notice'}, text:'Jede Person kann dem Ordnungsamt Hinweise auf mögliche Ordnungswidrigkeiten geben. Die Behörde prüft und entscheidet über die Verfolgung.' }
  ],
  datenschutz: [
    { cat:'cat_dsgvo', icon:'ℹ️', key:'dsgvo15', title:{de:'Art. 15 DSGVO — Auskunftsrecht',en:'Art. 15 GDPR — Access'}, preview:{de:'Recht auf Datenauskunft',en:'Right of access'}, text:'Die betroffene Person hat das Recht, von dem Verantwortlichen eine Bestätigung darüber zu verlangen, ob sie betreffende personenbezogene Daten verarbeitet werden, sowie Auskunft über diese Daten.' },
    { cat:'cat_dsgvo', icon:'🗑️', key:'dsgvo17', title:{de:'Art. 17 DSGVO — Recht auf Löschung',en:'Art. 17 GDPR — Erasure'}, preview:{de:'Recht auf Vergessenwerden',en:'Right to be forgotten'}, text:'Personenbezogene Daten sind unverzüglich zu löschen, wenn der Zweck der Verarbeitung entfallen ist, eine Einwilligung widerrufen wurde oder ein Widerspruch eingelegt wurde.' },
    { cat:'cat_dsgvo', icon:'🚫', key:'dsgvo7', title:{de:'Art. 7 DSGVO — Einwilligung',en:'Art. 7 GDPR — Consent'}, preview:{de:'Widerruf der Einwilligung',en:'Right to withdraw consent'}, text:'Die betroffene Person hat das Recht, ihre Einwilligung jederzeit zu widerrufen. Der Widerruf muss so einfach sein wie die Erteilung der Einwilligung.' },
    { cat:'cat_dsgvo', icon:'🛡️', key:'dsgvo77', title:{de:'Art. 77 DSGVO — Beschwerderecht',en:'Art. 77 GDPR — Right to complaint'}, preview:{de:'Beschwerde bei der Aufsichtsbehörde',en:'Supervisory authority complaint'}, text:'Jede betroffene Person hat das Recht auf Beschwerde bei einer Aufsichtsbehörde, wenn sie der Ansicht ist, dass die Verarbeitung ihrer Daten gegen die DSGVO verstößt.' },
    { cat:'cat_dsgvo', icon:'✏️', key:'dsgvo16', title:{de:'Art. 16 DSGVO — Berichtigungsrecht',en:'Art. 16 GDPR — Rectification'}, preview:{de:'Recht auf Berichtigung',en:'Right to rectification'}, text:'Die betroffene Person hat das Recht, von dem Verantwortlichen unverzüglich die Berichtigung sie betreffender unrichtiger personenbezogener Daten zu verlangen.' },
    { cat:'cat_dsgvo', icon:'🔒', key:'dsgvo18', title:{de:'Art. 18 DSGVO — Einschränkung',en:'Art. 18 GDPR — Restriction'}, preview:{de:'Recht auf Einschränkung der Verarbeitung',en:'Right to restriction'}, text:'Die betroffene Person hat das Recht, von dem Verantwortlichen die Einschränkung der Verarbeitung zu verlangen, wenn die Richtigkeit bestritten wird oder die Verarbeitung unrechtmäßig ist.' },
    { cat:'cat_dsgvo', icon:'💾', key:'dsgvo20', title:{de:'Art. 20 DSGVO — Datenübertragbarkeit',en:'Art. 20 GDPR — Portability'}, preview:{de:'Recht auf Datenübertragbarkeit',en:'Right to data portability'}, text:'Die betroffene Person hat das Recht, die sie betreffenden Daten in einem strukturierten, gängigen und maschinenlesbaren Format zu erhalten und an einen anderen Verantwortlichen zu übermitteln.' },
    { cat:'cat_dsgvo', icon:'📊', key:'dsgvo21', title:{de:'Art. 21 DSGVO — Widerspruchsrecht',en:'Art. 21 GDPR — Right to object'}, preview:{de:'Widerspruch gegen Profiling',en:'Object to profiling'}, text:'Die betroffene Person hat das Recht, aus Gründen ihrer besonderen Situation der Verarbeitung sie betreffender Daten zum Zwecke des Profilings zu widersprechen.' },
    { cat:'cat_dsgvo', icon:'📧', key:'uwg7', title:{de:'§ 7 UWG — Unzumutbare Belästigung',en:'§ 7 UWG — Harassment'}, preview:{de:'Unerlaubte Werbeanrufe / Spam',en:'Unsolicited advertising'}, text:'Werbung ohne vorherige ausdrückliche Einwilligung per E-Mail, Telefon oder SMS ist unzumutbar und wettbewerbswidrig gemäß § 7 UWG. Abmahnung und Schadensersatz möglich.' },
    { cat:'cat_dsgvo', icon:'⚖️', key:'dsgvo83', title:{de:'Art. 83 DSGVO — Bußgelder',en:'Art. 83 GDPR — Penalties'}, preview:{de:'Bußgelder bis 20 Mio. €',en:'Fines up to €20M'}, text:'Verstöße gegen die DSGVO können mit Geldbußen bis zu 20.000.000 € oder im Fall eines Unternehmens mit bis zu 4% des gesamten weltweit erzielten Jahresumsatzes geahndet werden.' },
    { cat:'cat_dsgvo', icon:'🏛️', key:'dsgvo57', title:{de:'Art. 57 DSGVO — Aufgaben Aufsichtsbehörde',en:'Art. 57 GDPR — Supervisory tasks'}, preview:{de:'Pflichten der Datenschutzbehörde',en:'Supervisory authority duties'}, text:'Die Aufsichtsbehörde ist verpflichtet, Beschwerden zu bearbeiten, Untersuchungen durchzuführen und bei Verstößen Sanktionen zu verhängen.' },
    { cat:'cat_dsgvo', icon:'📋', key:'bdsg', title:{de:'BDSG — Bundesdatenschutzgesetz',en:'BDSG — Federal Data Protection Act'}, preview:{de:'Nationales Datenschutzrecht',en:'National data protection'}, text:'Das Bundesdatenschutzgesetz (BDSG) ergänzt die DSGVO im deutschen Recht und regelt u.a. die Verarbeitung von Beschäftigtendaten und die Datenverarbeitung öffentlicher Stellen.' },
    { cat:'cat_dsgvo', icon:'🤝', key:'dsgvo26', title:{de:'Art. 26 DSGVO — Gemeinsame Verantwortliche',en:'Art. 26 GDPR — Joint controllers'}, preview:{de:'Gemeinsame Verarbeitung',en:'Joint processing'}, text:'Legen zwei oder mehr Verantwortliche gemeinsam die Zwecke der Verarbeitung fest, sind sie gemeinsam Verantwortliche und müssen ihre Aufgaben transparent festlegen.' },
    { cat:'cat_dsgvo', icon:'🔐', key:'dsgvo32', title:{de:'Art. 32 DSGVO — Datensicherheit',en:'Art. 32 GDPR — Security'}, preview:{de:'Technisch-organisatorische Maßnahmen',en:'Technical security measures'}, text:'Verantwortliche müssen angemessene technische und organisatorische Maßnahmen treffen, um ein dem Risiko angemessenes Schutzniveau zu gewährleisten (Verschlüsselung, Pseudonymisierung).' },
    { cat:'cat_dsgvo', icon:'🚨', key:'dsgvo33', title:{de:'Art. 33 DSGVO — Meldepflicht',en:'Art. 33 GDPR — Data breach notification'}, preview:{de:'Meldepflicht bei Datenpanne',en:'Breach notification duty'}, text:'Eine Verletzung des Schutzes personenbezogener Daten (Datenpanne) ist der Aufsichtsbehörde innerhalb von 72 Stunden zu melden.' }
  ],
  gewerbe: [
    { cat:'cat_gew', icon:'⏱️', key:'arbzg3', title:{de:'§ 3 ArbZG — Höchstarbeitszeit',en:'§ 3 ArbZG — Max. working time'}, preview:{de:'8h/Tag, max. 10h, 48h/Woche',en:'8h/day, max. 10h'}, text:'Die werktägliche Arbeitszeit darf 8 Stunden nicht überschreiten, kann auf 10 Stunden verlängert werden, wenn im Ausgleich über 6 Monate die 8h im Schnitt eingehalten werden.' },
    { cat:'cat_gew', icon:'⏱️', key:'arbzg4', title:{de:'§ 4 ArbZG — Ruhepausen',en:'§ 4 ArbZG — Rest breaks'}, preview:{de:'Pflichtpausen',en:'Mandatory breaks'}, text:'Bei mehr als 6 Stunden Arbeitszeit ist eine Pause von 30 Minuten, bei mehr als 9 Stunden von 45 Minuten zu gewähren. Pausen müssen im Voraus feststehen.' },
    { cat:'cat_gew', icon:'⏱️', key:'arbzg5', title:{de:'§ 5 ArbZG — Ruhezeiten',en:'§ 5 ArbZG — Rest periods'}, preview:{de:'11 Stunden Ruhezeit',en:'11 hour rest period'}, text:'Die Arbeitnehmer müssen nach Beendigung der täglichen Arbeitszeit eine ununterbrochene Ruhezeit von mindestens 11 Stunden haben.' },
    { cat:'cat_gew', icon:'👷', key:'arbschg4', title:{de:'§ 4 ArbSchG — Allgemeine Grundsätze',en:'§ 4 ArbSchG'}, preview:{de:'Sicherheit bei der Arbeit',en:'Safety at work'}, text:'Der Arbeitgeber hat Maßnahmen zu treffen, damit eine Gefährdung für Leben und Gesundheit möglichst vermieden und die verbleibende Gefährdung möglichst gering gehalten wird.' },
    { cat:'cat_gew', icon:'👷', key:'arbschg5', title:{de:'§ 5 ArbSchG — Gefährdungsbeurteilung',en:'§ 5 ArbSchG'}, preview:{de:'Pflicht zur Gefährdungsbeurteilung',en:'Risk assessment'}, text:'Der Arbeitgeber hat durch eine Beurteilung der Arbeitsbedingungen festzustellen, welche Maßnahmen des Arbeitsschutzes erforderlich sind.' },
    { cat:'cat_gew', icon:'📋', key:'arbstaettv', title:{de:'ArbStättV — Arbeitsstättenverordnung',en:'ArbStättV'}, preview:{de:'Anforderungen an Arbeitsräume',en:'Workplace requirements'}, text:'Die ArbStättV regelt Mindestanforderungen an Arbeitsstätten: Raumtemperatur (19-26°C), Belüftung, Beleuchtung, sanitäre Einrichtungen und Fluchtwege.' },
    { cat:'cat_gew', icon:'🧼', key:'lmhv', title:{de:'LMHV — Lebensmittelhygieneverordnung',en:'LMHV'}, preview:{de:'Hygienepflichten Gastronomie',en:'Food hygiene'}, text:'Die LMHV verpflichtet Lebensmittelunternehmer, alle Stufen der Erzeugung und des Inverkehrbringens unter Hygienebedingungen durchzuführen. Verstöße: Betriebsschließung.' },
    { cat:'cat_gew', icon:'🛢️', key:'gefstoffv', title:{de:'GefStoffV — Gefahrstoffverordnung',en:'GefStoffV'}, preview:{de:'Umgang mit Gefahrstoffen',en:'Hazardous substances'}, text:'Die GefStoffV regelt den Umgang mit Gefahrstoffen am Arbeitsplatz: Informationspflicht, Lagerung, Schutzausrüstung und Unterweisung der Arbeitnehmer sind Pflicht.' },
    { cat:'cat_gew', icon:'📅', key:'arbzg9', title:{de:'§ 9 ArbZG — Sonn- und Feiertagsruhe',en:'§ 9 ArbZG — Sunday rest'}, preview:{de:'Verbot der Sonntagsarbeit',en:'Sunday work ban'}, text:'Arbeitnehmer dürfen an Sonn- und gesetzlichen Feiertagen nicht beschäftigt werden. Ausnahmen bedürfen einer Genehmigung der Aufsichtsbehörde.' },
    { cat:'cat_gew', icon:'🧒', key:'jarbschg', title:{de:'JArbSchG — Jugendarbeitsschutzgesetz',en:'JArbSchG'}, preview:{de:'Schutz minderjähriger Arbeitnehmer',en:'Youth worker protection'}, text:'Das JArbSchG schützt Minderjährige: max. 8h/Tag, keine Nachtarbeit (ab 20:00 Uhr), verlängerte Pausen, gesonderte Urlaubsansprüche.' },
    { cat:'cat_gew', icon:'🚪', key:'asra22', title:{de:'ASR A2.3 — Fluchtwege',en:'ASR A2.3 — Escape routes'}, preview:{de:'Vorschriften zu Fluchtwegen',en:'Emergency escape routes'}, text:'Fluchtwege und Notausgänge müssen ständig freigehalten, beschildert (grüne Schilder) und zu jeder Zeit benutzbar sein. Blockierte Fluchtwege sind ein unmittelbares Sicherheitsrisiko.' },
    { cat:'cat_gew', icon:'🌡️', key:'asra35', title:{de:'ASR A3.5 — Temperaturen',en:'ASR A3.5 — Temperature'}, preview:{de:'Arbeitsplatztemperaturen',en:'Workplace temperatures'}, text:'Arbeitsräume müssen auf mindestens 19°C beheizt werden. Bei über 26°C sind Maßnahmen zu ergreifen (Sonnenschutz, Lüftung). Über 30°C sind Sofortmaßnahmen erforderlich.' },
    { cat:'cat_gew', icon:'🙉', key:'larmvibrations', title:{de:'LärmVibrationsArbSchV',en:'LärmVibrationsArbSchV'}, preview:{de:'Lärmschutz am Arbeitsplatz',en:'Noise protection'}, text:'Der Arbeitgeber muss Lärm am Arbeitsplatz beurteilen und ab einem Tageslärmexpositionspegel von 80 dB(A) Schutzmaßnahmen ergreifen (Gehörschutz, Lärmreduzierung).' },
    { cat:'cat_gew', icon:'⚖️', key:'owig130', title:{de:'§ 130 OWiG — Aufsichtspflichtverletzung',en:'§ 130 OWiG'}, preview:{de:'Betriebsinhaber haftet',en:'Owner liability'}, text:'Betriebsinhaber haften nach § 130 OWiG für Verstöße, die durch mangelnde Aufsicht entstehen. Bußgeld bis zu 1.000.000 €.' },
    { cat:'cat_gew', icon:'💶', key:'milog', title:{de:'MiLoG — Mindestlohngesetz',en:'MiLoG — Minimum wage'}, preview:{de:'Gesetzlicher Mindestlohn',en:'Minimum wage'}, text:'Der gesetzliche Mindestlohn ist an alle Arbeitnehmer in Deutschland zu zahlen. Verstöße werden mit Bußgeldern bis zu 500.000 € geahndet, bei Wiederholung Ausschluss von Aufträgen.' }
  ],
  tier: [
    { cat:'cat_tier', icon:'🐶', key:'tierschg2', title:{de:'§ 2 TierSchG — Tierhalterpflichten',en:'§ 2 TierSchG'}, preview:{de:'Artgerechte Haltung',en:'Species-appropriate keeping'}, text:'Wer ein Tier hält, muss es seiner Art entsprechend angemessen ernähren, pflegen und verhaltensgerecht unterbringen. Beeinträchtigungen durch Übermaß oder unangemessene Haltung sind verboten.' },
    { cat:'cat_tier', icon:'🚫', key:'tierschg17', title:{de:'§ 17 TierSchG — Straftatbestand',en:'§ 17 TierSchG — Cruelty'}, preview:{de:'Tötung oder Quälerei',en:'Killing or cruelty'}, text:'Mit Freiheitsstrafe bis zu 3 Jahren oder Geldstrafe wird bestraft, wer ein Wirbeltier ohne vernünftigen Grund tötet oder ihm aus Rohheit erhebliche Schmerzen zufügt.' },
    { cat:'cat_tier', icon:'🏥', key:'tierschg5', title:{de:'§ 5 TierSchG — Tierschutzeingriffe',en:'§ 5 TierSchG'}, preview:{de:'Verbote von Eingriffen',en:'Prohibited procedures'}, text:'Eingriffe an Tieren dürfen nur von Tierärzten und nur mit Betäubung vorgenommen werden. Das Kupieren von Schwänzen und Ohren ist grundsätzlich verboten.' },
    { cat:'cat_tier', icon:'🏚️', key:'tierschg11', title:{de:'§ 11 TierSchG — Erlaubnispflicht',en:'§ 11 TierSchG'}, preview:{de:'Genehmigungspflicht Handel/Zucht',en:'Permit requirement'}, text:'Wer gewerbsmäßig Tiere züchtet, handelt oder zur Schau stellt, bedarf einer Erlaubnis der zuständigen Behörde. Illegale Welpenzucht ist strafbar.' },
    { cat:'cat_tier', icon:'🐕', key:'hundeverordnung', title:{de:'TierSchHuV — Hundehaltungsverordnung',en:'Dog Protection Ordinance'}, preview:{de:'Mindestanforderungen Hundehaltung',en:'Minimum dog keeping standards'}, text:'Die Tierschutz-Hundeverordnung regelt Mindestanforderungen für Zwinger, Auslauf, Ernährung und soziale Kontakte für Hunde. Verstöße sind bußgeldbewehrt.' },
    { cat:'cat_tier', icon:'⛓️', key:'tierschgnutztierhv', title:{de:'TierSchNutztV — Nutztierverordnung',en:'Livestock ordinance'}, preview:{de:'Mindestanforderungen Nutztierhaltung',en:'Livestock standards'}, text:'Die TierSchNutztV legt Mindestanforderungen für Haltung, Fütterung und Pflege von Nutztieren fest. Massive Verstöße können zur Sicherstellung der Tiere führen.' },
    { cat:'cat_tier', icon:'📦', key:'tierschg18', title:{de:'§ 18 TierSchG — Ordnungswidrigkeiten',en:'§ 18 TierSchG — Violations'}, preview:{de:'Bußgelder bei Verstößen',en:'Fines for violations'}, text:'Verstöße gegen tierschutzrechtliche Vorschriften (z.B. unzureichende Fütterung, unangemessene Unterbringung) sind Ordnungswidrigkeiten, die mit Bußgeldern bis zu 25.000 € geahndet werden.' },
    { cat:'cat_tier', icon:'🏛️', key:'bjagdg', title:{de:'BJagdG — Bundesjagdgesetz',en:'Federal Hunting Act'}, preview:{de:'Verbot illegaler Jagdmethoden',en:'Illegal hunting ban'}, text:'Das Bundesjagdgesetz regelt die Jagd in Deutschland. Das Aufstellen von Schlingen, Giften oder anderen illegalen Vorrichtungen ist verboten und strafbar.' },
    { cat:'cat_tier', icon:'🌿', key:'bnatschg', title:{de:'BNatSchG — Artenschutz',en:'BNatSchG — Species protection'}, preview:{de:'Schutz von Wildtieren',en:'Wildlife protection'}, text:'Das Bundesnaturschutzgesetz schützt wild lebende Tiere vor Nachstellung, Fang, Verletzung und Tötung. Verstöße sind strafbar (Freiheitsstrafe bis zu 5 Jahren).' },
    { cat:'cat_tier', icon:'🔥', key:'tierschg16a', title:{de:'§ 16a TierSchG — Behördliche Maßnahmen',en:'§ 16a TierSchG — Official measures'}, preview:{de:'Sicherstellung und Beschlagnahme',en:'Seizure of animals'}, text:'Das Veterinäramt kann Tiere von einem Halter wegsicherstellen und einem Dritten zur Pflege übergeben, wenn unmittelbare Gefahr für das Wohl des Tieres besteht.' },
    { cat:'cat_tier', icon:'🚗', key:'stvo19', title:{de:'§ 19 StVO — Tiere im Fahrzeug',en:'§ 19 StVO — Animals in vehicles'}, preview:{de:'Tiere sicher transportieren',en:'Safe animal transport'}, text:'Tiere sind in Fahrzeugen so zu sichern, dass sie nicht gefährdet werden. Das Einschließen von Tieren in überhitzten Fahrzeugen ist Tierquälerei gemäß § 17 TierSchG.' },
    { cat:'cat_tier', icon:'🏥', key:'tierschg17_2', title:{de:'§ 17 Nr. 2 TierSchG — Vernachlässigung',en:'§ 17 No. 2 TierSchG'}, preview:{de:'Erhebliches Leiden durch Unterlassung',en:'Suffering by neglect'}, text:'Auch wer einem Tier durch grobe Vernachlässigung länger anhaltende erhebliche Schmerzen oder Leiden zufügt, macht sich strafbar (Freiheitsstrafe bis zu 3 Jahren).' },
    { cat:'cat_tier', icon:'📋', key:'tierschg16', title:{de:'§ 16 TierSchG — Überwachung',en:'§ 16 TierSchG — Supervision'}, preview:{de:'Befugnisse des Veterinäramts',en:'Vet authority powers'}, text:'Behörden (Veterinäramt) können Betriebe und Privatpersonen kontrollieren, um die Einhaltung des Tierschutzgesetzes zu überwachen. Sie dürfen Grundstücke betreten.' },
    { cat:'cat_tier', icon:'💉', key:'bstierseuchng', title:{de:'TierSG — Tierseuchengesetz',en:'Animal Disease Act'}, preview:{de:'Meldepflicht bei Tierkrankheiten',en:'Disease reporting'}, text:'Bei bestimmten Tierkrankheiten besteht Anzeigepflicht gegenüber der Behörde. Tierhaltung ohne tierärztliche Versorgung bei erkennbaren Krankheiten ist bußgeldbewehrt.' },
    { cat:'cat_tier', icon:'⚖️', key:'stgb303_tier', title:{de:'§ 303 StGB analog — Vernichtung',en:'§ 303 StGB — Destruction'}, preview:{de:'Tiere als Sachen im Recht',en:'Animals as legal property'}, text:'Obwohl Tiere keine Sachen sind (§ 90a BGB), gelten die Vorschriften über Sachen entsprechend. Vorsätzliche Schädigung von Tieren anderer Personen ist auch zivilrechtlich verfolgt.' }
  ],
  finanzamt: [
    { cat:'cat_fin', icon:'📉', key:'ao370', title:{de:'§ 370 AO — Steuerhinterziehung',en:'§ 370 AO — Tax evasion'}, preview:{de:'Straftatbestand',en:'Criminal offense'}, text:'Mit Freiheitsstrafe bis zu 5 Jahren oder Geldstrafe wird bestraft, wer den Finanzbehörden unrichtige oder unvollständige Angaben über steuererhebliche Tatsachen macht.' },
    { cat:'cat_fin', icon:'💸', key:'schwarzarbg1', title:{de:'§ 1 SchwarzArbG — Schwarzarbeit',en:'§ 1 SchwarzArbG'}, preview:{de:'Definition und Verbot',en:'Definition and prohibition'}, text:'Schwarzarbeit leisten Personen, die Dienst- oder Werkleistungen erbringen oder ausführen lassen und dabei steuerrechtliche, sozialversicherungsrechtliche oder meldepflichten nicht erfüllen.' },
    { cat:'cat_fin', icon:'💸', key:'schwarzarbg2', title:{de:'§ 2 SchwarzArbG — Behördliche Kontrolle',en:'§ 2 SchwarzArbG'}, preview:{de:'Kontrolle durch Zoll/FKS',en:'Customs control'}, text:'Die Finanzkontrolle Schwarzarbeit (FKS) des Zolls ist berechtigt, Betriebe zu kontrollieren, Identitäten festzustellen und Unterlagen zu prüfen.' },
    { cat:'cat_fin', icon:'🧾', key:'ao146a', title:{de:'§ 146a AO — Kassenpflicht',en:'§ 146a AO — POS system obligation'}, preview:{de:'Belegausgabepflicht',en:'Receipt issuance duty'}, text:'Unternehmer sind verpflichtet, ihren Kunden bei Bareinkäufen einen Beleg auszustellen. Manipulationen am Kassensystem sind strafbar (§ 379 AO).' },
    { cat:'cat_fin', icon:'📊', key:'ustg', title:{de:'UStG — Umsatzsteuergesetz',en:'UStG — VAT Act'}, preview:{de:'Umsatzsteuerpflicht',en:'VAT obligation'}, text:'Unternehmer sind zur vollständigen Aufzeichnung und Abführung der Umsatzsteuer verpflichtet. Bewusstes Unterschlagen von Einnahmen ist Steuerhinterziehung.' },
    { cat:'cat_fin', icon:'💶', key:'milog_fin', title:{de:'MiLoG — Mindestlohn',en:'MiLoG — Minimum wage'}, preview:{de:'Kontrolle durch Zoll',en:'Customs enforcement'}, text:'Die Einhaltung des gesetzlichen Mindestlohns wird vom Zoll kontrolliert. Verstöße werden mit Bußgeldern bis zu 500.000 € geahndet.' },
    { cat:'cat_fin', icon:'🤝', key:'sgb4', title:{de:'§ 7 SGB IV — Sozialversicherungspflicht',en:'§ 7 SGB IV — Social security'}, preview:{de:'Sozialversicherungspflicht für Arbeitnehmer',en:'Social insurance obligation'}, text:'Beschäftigte sind sozialversicherungspflichtig. Arbeitgeber, die keine Beiträge abführen, machen sich des Vorenthaltens von Arbeitsentgelt strafbar (§ 266a StGB).' },
    { cat:'cat_fin', icon:'⚖️', key:'stgb266a', title:{de:'§ 266a StGB — Vorenthalten von Arbeitsentgelt',en:'§ 266a StGB'}, preview:{de:'Nichtabführen von Sozialabgaben',en:'Withholding social contributions'}, text:'Wer als Arbeitgeber der Einzugsstelle Beiträge zur Sozialversicherung vorenthält, wird mit Freiheitsstrafe bis zu 5 Jahren bestraft.' },
    { cat:'cat_fin', icon:'📬', key:'stgb261', title:{de:'§ 261 StGB — Geldwäsche',en:'§ 261 StGB — Money laundering'}, preview:{de:'Verschleierung illegaler Gewinne',en:'Concealment of illicit profits'}, text:'Wer einen Gegenstand, der aus einer Straftat stammt, verbirgt, verschleiert oder seine Herkunft verschleiert, macht sich der Geldwäsche schuldig (Freiheitsstrafe bis zu 10 Jahren).' },
    { cat:'cat_fin', icon:'🚬', key:'tabaksteuergesetz', title:{de:'TabStG — Tabaksteuergesetz',en:'TabStG — Tobacco Tax Act'}, preview:{de:'Steuer auf Tabakwaren',en:'Tobacco tax'}, text:'Der Verkauf unversteuerter oder nicht für den deutschen Markt bestimmter Tabakwaren (Zigarettenschmuggel) ist ein Steuerstrafdelikt und wird durch den Zoll verfolgt.' },
    { cat:'cat_fin', icon:'🕴️', key:'stgb14', title:{de:'§ 14 StGB — Organ- und Vertreterhaftung',en:'§ 14 StGB'}, preview:{de:'Geschäftsführer-Verantwortlichkeit',en:'Director liability'}, text:'Handelt jemand als Organ, als Gesellschafter oder als gesetzlicher Vertreter einer juristischen Person, gelten Strafgesetze auch für ihn persönlich, wenn die Voraussetzungen für die Strafbarkeit bei der juristischen Person vorliegen.' },
    { cat:'cat_fin', icon:'🔍', key:'ao30', title:{de:'§ 30 AO — Steuergeheimnis',en:'§ 30 AO — Tax secrecy'}, preview:{de:'Vertraulichkeit von Hinweisen',en:'Confidentiality of tips'}, text:'Hinweise an das Finanzamt unterliegen dem Steuergeheimnis. Die Behörde ist zur Vertraulichkeit verpflichtet – der Hinweisgeber bleibt anonym.' },
    { cat:'cat_fin', icon:'📋', key:'ao93', title:{de:'§ 93 AO — Auskunftspflicht',en:'§ 93 AO — Duty to provide information'}, preview:{de:'Auskunftspflichten Dritter',en:'Third-party duty to provide info'}, text:'Finanzbehörden können von Dritten Auskünfte verlangen, soweit dies für die Ermittlung des Steuerschuldverhältnisses notwendig ist.' },
    { cat:'cat_fin', icon:'🏛️', key:'bkafinanzermittlung', title:{de:'BKA — Geldwäscheermittlungen',en:'BKA — Money laundering investigations'}, preview:{de:'Koordination durch BKA',en:'BKA coordination'}, text:'Das Bundeskriminalamt koordiniert Geldwäscheermittlungen. Verdachtsmeldungen können über das BKA-Portal oder die Financial Intelligence Unit (FIU) erstattet werden.' },
    { cat:'cat_fin', icon:'💰', key:'ao393', title:{de:'§ 393 AO — Verhältnis zum Strafverfahren',en:'§ 393 AO'}, preview:{de:'Keine Selbstbelastung im Steuerverfahren',en:'No self-incrimination'}, text:'Angaben des Steuerpflichtigen im Besteuerungsverfahren dürfen im Strafverfahren nur unter bestimmten Voraussetzungen verwendet werden (Schweigerecht).' }
  ]
};
